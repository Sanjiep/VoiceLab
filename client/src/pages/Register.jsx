...
export default function Register() {
  ...
  return (
    <div className="min-h-screen flex bg-white dark:bg-[#0a0a0a] transition-colors duration-300">
      ...
      <div className="hidden lg:flex w-1/2 flex-col p-14 relative border-r border-gray-100 dark:border-[#1f1f1f] bg-black overflow-hidden">

        {/* Animated gradient orbs */}
        <div style={{ position: 'absolute', inset: 0, overflow: 'hidden', zIndex: 0 }}>
          <div style={{
            position: 'absolute', width: '600px', height: '600px',
            borderRadius: '50%', background: 'rgba(120, 80, 255, 0.12)',
            filter: 'blur(80px)', top: '-100px', left: '-100px',
            animation: 'orb1 10s ease-in-out infinite alternate',
          }} />
          <div style={{
            position: 'absolute', width: '500px', height: '500px',
            borderRadius: '50%', background: 'rgba(80, 160, 255, 0.1)',
            filter: 'blur(80px)', bottom: '-100px', right: '-100px',
            animation: 'orb2 12s ease-in-out infinite alternate',
          }} />
          <div style={{
            position: 'absolute', width: '400px', height: '400px',
            borderRadius: '50%', background: 'rgba(255, 80, 180, 0.08)',
            filter: 'blur(80px)', top: '50%', left: '30%',
        ...
        {/* Bottom stats */}
        <div className="flex gap-8 mt-auto pt-8 border-t border-[#1f1f1f] relative z-10">
          <div>
        ...
        <div className="flex-1 flex items-center justify-center p-8">
          <div className="w-full max-w-sm">
            ...
            <p className="text-center text-xs text-gray-400 dark:text-white/20 mt-6">
              ...
              <Link
                to="/login"
                className="text-gray-600 dark:text-white/40 underline hover:text-gray-900 dark:hover:text-white transition"
              >
                Sign in
              </Link>
            </p>

            <p className="text-center text-xs text-gray-400 dark:text-white/20 mt-3">
              By creating an account, you agree to our{" "}
              <a href="#" className="underline hover:text-gray-600 dark:hover:text-white/40">Terms</a>{" "}
              and{" "}
              <a href="#" className="underline hover:text-gray-600 dark:hover:text-white/40">Privacy Policy</a>
            </p>
          </div>
        </div>
      </div>
